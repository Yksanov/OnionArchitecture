        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonNameId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Requests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Requests_GroupTypes_GroupTypeId",
                        column: x => x.GroupTypeId,
                        principalTable: "GroupTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_LessonNames_LessonNameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teachers_LessonNames_LessonNameId",
                        column: x => x.LessonNameId,
                        principalTable: "LessonNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Invited = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrialLessons_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentType = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherFromId = table.Column<int>(type: "integer", nullable: true),
                    TeacherToId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Operations_Teachers_TeacherFromId",
                        column: x => x.TeacherFromId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Operations_Teachers_TeacherToId",
                        column: x => x.TeacherToId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Operations_TeacherFromId",
                table: "Operations",
                column: "TeacherFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Operations_TeacherToId",
                table: "Operations",
                column: "TeacherToId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_GroupTypeId",
                table: "Requests",
                column: "GroupTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_LessonNameId",
                table: "Requests",
                column: "LessonNameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_LessonNameId",
                table: "Teachers",
                column: "LessonNameId");

            migrationBuilder.CreateIndex(
                name: "IX_TrialLessons_TeacherId",
                table: "TrialLessons",
                column: "TeacherId");
        }
